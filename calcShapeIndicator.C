...
TH2D* getSI(int runnum = 5){
    ...
    // Define Histgrams
    auto si = new TH2D(Form("si%01d",runnum),Form("si%01d",runnum),1000,-0.1,1.9,1000,-0.01,0.02);
    ...
    // Event Begin ===>
        ...
        si->Fill(area*calFac,SumWfP/SumWf);
    ...
    si->SaveAs(Form("../areaVsSI/hist%01d.root",runnum));
